...
const MostaqlIcon = () => (
  // <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  // </svg>
  <img src="src\components\mostaqel.png" alt="mostaqel img" />
);
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            >
              Have a project in mind? Looking for a freelancer to bring your
              vision to life? I'd love to hear from you. I'm always open to new
              ...
              {[
                {
                  icon: "📧",
                  label: "Email",
                  val: "ammar.s.fouad555@gmail.com",
                  href: "mailto:ammar.s.fouad555@gmail.com",
                },
                  ...
                  <div>
                    ...
                    {href ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        style={{ color: "var(--accent2)", fontSize: ".95rem" }}
                      >
                        {val}
                      </a>
                    ) : (
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                {errors.name && (
                  <span style={{ fontSize: ".8rem", color: "#ef4444" }}>
                    {errors.name}
                  </span>
                )}
              </div>
